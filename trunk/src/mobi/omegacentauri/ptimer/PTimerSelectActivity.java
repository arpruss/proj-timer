...
import mobi.omegacentauri.ptimer.soundfile.CheapSoundFile;
    ...
    implements TextWatcher
{
    ...
    private boolean chooseContactForRingtone(MenuItem item){
        try {
            ...
            "mobi.omegacentauri.ptimer.ChooseContactActivity");
    ...
    private void confirmDelete() {
        ...
        if (artist.equals(ringdroidArtist)) {
            message = getResources().getText(
                    R.string.confirm_delete_ProjTimer);
        } else {
            message = getResources().getText(
                    R.string.confirm_delete_non_ProjTimer);
        }
